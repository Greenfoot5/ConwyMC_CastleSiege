...
public class Messages_Twinbridge {
		...
		if (MapController.currentMapIs("Thunderstone")) {
			...
			if (TS_FlagRadius.isPlayerInRadius(p, flag)) {
				...
				if (flag.equalsIgnoreCase("twinbridge")) {
					...
					if (TS_FlagRadius.twinbridge1.contains(p) || TS_FlagRadius.twinbridge2.contains(p)) {

						if (TS_FlagRadius.twinbridge1.size() <= 1 || TS_FlagRadius.twinbridge2.size() <= 1) {
						...
						if (TS_FlagRadius.twinbridge1.size() == 2 || TS_FlagRadius.twinbridge2.size() == 2) {
						...
						if (TS_FlagRadius.twinbridge1.size() == 3 || TS_FlagRadius.twinbridge2.size() == 3) {
						...
						if (TS_FlagRadius.twinbridge1.size() >= 4 || TS_FlagRadius.twinbridge2.size() >= 4) {
