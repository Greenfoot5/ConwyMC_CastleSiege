...
public class Main extends JavaPlugin implements Listener {
    ...
    private void registerCoinShop() {
        ...
        gui.addCoinShopItem("Elytrier", Material.ELYTRA, 14);
        gui.addCoinShopItem("Fallen", Material.WITHER_SKELETON_SKULL, 15);
        gui.addCoinShopItem("MoriaOrc", Material.BOW, 16);
        gui.addCoinShopItem("DwarvenAxeThrower", Material.STONE_AXE, 17);
        gui.addCoinShopItem("DwarvenGuardian", Material.SHIELD, 18);
        gui.addCoinShopItem("MoriaCaveTroll", Material.IRON_INGOT, 19);
        gui.addCoinShopItem("MoriaBonecrusher", Material.BONE, 20);
        gui.addCoinShopItem("DwarvenWindlancer", Material.STICK, 21);
        gui.addCoinShopItem("UrukBerserker", Material.BEETROOT_SOUP, 22);
        gui.addCoinShopItem("Lancer", Material.STICK, 23);
        gui.addCoinShopItem("RangedCavalry", Material.BOW, 24);
        gui.addCoinShopItem("Abyssal", Material.GREEN_DYE, 25);
        gui.addCoinShopItem("Hellsteed", Material.MAGMA_BLOCK, 26);
        gui.addCoinShopItem("RoyalKnight", Material.DIAMOND_HORSE_ARMOR, 27);
        gui.addCoinShopItem("Arbalester", Material.CROSSBOW, 28);
