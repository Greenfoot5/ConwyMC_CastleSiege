...
public class KitGui_Isengard {
	...
	public Inventory KitGui(Player p) {
		...
		//name
		itemMeta4.setDisplayName(ChatColor.DARK_GRAY + "Uruk-hai Kits");
		//lore
		ArrayList<String> lore4 = new ArrayList<String>();
		lore4.add(ChatColor.DARK_PURPLE + "Play kits unique to Uruk-hai,");
		lore4.add(ChatColor.DARK_PURPLE + "However certain kits will have to be unlocked");
		lore4.add(ChatColor.DARK_PURPLE + "with coins first.");
		...
		//name
		itemMeta5.setDisplayName(ChatColor.DARK_GRAY + "Orc Kits");
		//lore
		ArrayList<String> lore5 = new ArrayList<String>();
		lore5.add(ChatColor.DARK_PURPLE + "Play kits unique to the Orcs,");
		lore5.add(ChatColor.DARK_PURPLE + "However certain kits will have to be unlocked");
		lore5.add(ChatColor.DARK_PURPLE + "with coins first.");
		...
		GUI.setItem(35, panel); GUI.setItem(36, panel); GUI.setItem(37, panel); GUI.setItem(38, item4); GUI.setItem(39, panel);
		GUI.setItem(40, panel); GUI.setItem(41, panel); GUI.setItem(42, item5); GUI.setItem(43, panel); GUI.setItem(44, panel);
