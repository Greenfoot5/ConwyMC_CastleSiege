...
public class Caves_Urukhai {
	...
	public static void CapturingProcessA1(Player e) {
		...
		Block flagLayer1Block1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 870, 54, 942).getBlock();
		Block flagLayer1Block2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 870, 55, 942).getBlock();
		Block flagLayer1Block3 = new Location(plugin.getServer().getWorld("HelmsDeep"), 870, 56, 942).getBlock();
		Block flagLayer1Block4 = new Location(plugin.getServer().getWorld("HelmsDeep"), 870, 57, 942).getBlock();
		Block flagLayer2Block1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 866, 54, 942).getBlock();
		Block flagLayer2Block2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 866, 55, 942).getBlock();
		Block flagLayer2Block3 = new Location(plugin.getServer().getWorld("HelmsDeep"), 866, 56, 942).getBlock();
		Block flagLayer2Block4 = new Location(plugin.getServer().getWorld("HelmsDeep"), 866, 57, 942).getBlock();
		Block flagb1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1753, 23, 962).getBlock();
		Block flagb2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 272, 13, 955).getBlock();
