...
public class KitGui_Rohan {
	...
	public Inventory KitGui(Player p) {
		...
		//name
		itemMeta4.setDisplayName(ChatColor.DARK_GREEN + "Rohan Kits");
		//lore
		ArrayList<String> lore4 = new ArrayList<String>();
		lore4.add(ChatColor.DARK_PURPLE + "Play kits unique to Rohan,");
		...
		//name
		itemMeta5.setDisplayName(ChatColor.DARK_GREEN + "Elven Kits");
		//lore
		ArrayList<String> lore5 = new ArrayList<String>();
		lore5.add(ChatColor.DARK_PURPLE + "Play kits unique to the Elves,");
