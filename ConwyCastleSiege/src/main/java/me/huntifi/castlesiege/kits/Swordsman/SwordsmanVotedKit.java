...
public class SwordsmanVotedKit {
	...
	public SwordsmanVotedKit() {
		...
		IronSwordMeta.addEnchant(Enchantment.DAMAGE_ALL, 24, true);
	...
	public ItemStack getSwordsmanVotedSword() {
		return IronSword;

	}  
	
	public ItemStack getSwordsmanVotedLadders() {
		return Ladders;

	}  
	
	public ItemStack getSwordsmanVotedBoots() {
		return Boots;
