...
public class CavalryVotedKit {
	...
	public CavalryVotedKit() {
		...
		StoneSwordMeta.addEnchant(Enchantment.DAMAGE_ALL, 18, true);
	...
	public ItemStack getCavalryVotedSword() {
		return StoneSword;

	} 
	
	public ItemStack getCavalryVotedLadders() {
		return Ladders;

	}  
	
	public ItemStack getCavalryVotedBoots() {
		return Boots;
