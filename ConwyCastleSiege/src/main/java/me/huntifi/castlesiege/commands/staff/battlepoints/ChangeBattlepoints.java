 ...
 */
public abstract class ChangeBattlepoints implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.plugin, () -> changeBattlepoints(sender, args));
        return true;
    }
     ...
     * @param args Passed command arguments
     */
    private void changeBattlepoints(CommandSender sender, String[] args) {
        ...
        if (data != null)
            changeBattlepointsOnline(data, amount);
        else
     ...
     */
    protected abstract void changeBattlepointsOnline(PlayerData data, double amount);
