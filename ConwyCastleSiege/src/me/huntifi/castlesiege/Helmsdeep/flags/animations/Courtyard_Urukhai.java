...
public class Courtyard_Urukhai {
	...
	public static void CapturingProcessA1(Player e) {
		...
		Material FlagMaterialLayer2Block1 = Material.BLACK_WOOL;
		Material FlagMaterialLayer2Block2 = Material.BLACK_WOOL;
		Material FlagMaterialLayer2Block3 = Material.BLACK_WOOL;
		Material FlagMaterialLayer2Block4 = Material.BLACK_WOOL;
		Block flagLayer1Block1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 78, 1002).getBlock();
		Block flagLayer1Block2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 79, 1002).getBlock();
		Block flagLayer1Block3 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 80, 1002).getBlock();
		Block flagLayer1Block4 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 81, 1002).getBlock();
		Block flagLayer2Block1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 78, 998).getBlock();
		Block flagLayer2Block2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 79, 998).getBlock();
		Block flagLayer2Block3 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 80, 998).getBlock();
		Block flagLayer2Block4 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1022, 81, 998).getBlock();
		Block flagb1 = new Location(plugin.getServer().getWorld("HelmsDeep"), 1753, 19, 960).getBlock();
		Block flagb2 = new Location(plugin.getServer().getWorld("HelmsDeep"), 274, 17, 955).getBlock();
