...
public class CamelSpawner {
    ...
    public void spawn(Player p) {
        ...
        // Set attributes
        AttributeInstance healthAttribute = camel.getAttribute(Attribute.GENERIC_MAX_HEALTH);
        AttributeInstance kbAttribute = camel.getAttribute(Attribute.GENERIC_KNOCKBACK_RESISTANCE);
        AttributeInstance speedAttribute = camel.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED);
        AttributeInstance jumpAttribute = camel.getAttribute(Attribute.HORSE_JUMP_STRENGTH);
