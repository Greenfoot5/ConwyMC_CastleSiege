...
public class Tips extends BukkitRunnable {
    ...
    private static final String[] tips = new String[] {
            ...
            "Found a suspicious player? Make a report on the §e/discord§r server or §e/msg§r a staff member",
            ...
            "Found a bug or exploit? Report it on the §e/discord§r server.",
            ...
            "Need a refresher on the rules? You can view them with §e/rules§r!",
