...
public class Tips extends BukkitRunnable {
    ...
    private static final String[] tips = new String[] {
            ...
            "Donators can launch some neat fireworks using <yellow><click:run_command:/firework>/firework</click></yellow> or <yellow><click:run_command:/fw>/fw</click></yellow>",
            "Don't forget to vote to gain access to special boosts and classes!",
            "Stuck somewhere, or have no way out? Use <yellow><insert:/sui>/sui</insert></yellow>",
            "Want to help the server? Record or stream the play sessions and upload them!",
            //"Want to help the server? Help us advertise!",
            "Use <yellow><click:run_command:/settings>/settings</click></yellow> to have options to change certain mechanics.",
            "Rogue's can mark their enemies by hitting them with track arrows.",
            "Crossbowmen can toggle between Mobility & Sniper modes.",
            "<yellow><insert:/settings>/settings</insert></yellow> opens a menu that allows you to change multiple settings.",
